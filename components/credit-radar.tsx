  ...
  useEffect(() => {
    if (creditScore) {
      const timer = setTimeout(() => {
        ...
        setFactors([
          { name: "Repayment History", value: creditScore.breakdown.repaymentHistory, color: "hsl(var(--primary))" },
          {
            name: "Transaction Frequency",
            value: creditScore.breakdown.transactionFrequency,
            color: "hsl(var(--primary) / 0.8)",
          },
          { name: "Savings Balance", value: creditScore.breakdown.savingsPattern, color: "hsl(var(--primary) / 0.6)" },
          { name: "Social Trust", value: creditScore.breakdown.socialConnections, color: "hsl(var(--primary) / 0.9)" },
          { name: "Account Age", value: creditScore.breakdown.accountAge, color: "hsl(var(--primary) / 0.5)" },
        ])
      }, 500)
  ...
  return (
    <Card>
      <CardHeader className="pb-2">
        ...
        <CardDescription>Based on your MiniPay activity</CardDescription>
      </CardHeader>
